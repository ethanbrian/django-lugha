...
SECRET_KEY = 'django-insecure-ew-v0&$_l$ppaiyo0iq$mluqb080i71iqc!z1fob3pjo=@z5sg'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

# Add 'djangolugha.drlugha.com' to ALLOWED_HOSTS
ALLOWED_HOSTS = ['localhost', '127.0.0.1', '[::1]', 'djangolugha.drlugha.com']
